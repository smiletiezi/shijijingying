...
<!-- 搜索 -->
	...
	<script type="text/html" id="rbtn">
     ...
     <a class="layui-btn layui-btn-xs" lay-event="edit">编辑</a>
      <a class="layui-btn layui-btn-xs" lay-event="down">下级</a>
	</script>
	...
	layui.use(['table','form'], function(){
	  ...
	  table.on('tool(tableFilter)', function(obj){
	    ...
	    if(layEvent === 'edit'){
	      doForm('编辑',data.userid);
	    }
	    if(layEvent === 'down'){
		      doDown('下级',data.userid);
		    }
	  });
	...
	function doDown(title,id){
		layer.open({
			  ...
			  maxmin: true,
			  area: ['100%','100%'],
			  content: '${ctx}/sysuser/toDown?userid='+id
		 });
	}
