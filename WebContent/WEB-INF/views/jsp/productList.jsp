...
<body class="contPadding">
	...
	<div class="search">
		<form class="layui-form"> 
			...
			<div class="layui-inline">
				<input class="layui-input" name="productName" id="productName" autocomplete="off" placeholder="请输入产品名称">
			</div>
	...
	layui.use(['table','form'], function(){
	  ...
	  table.render({
	    ...
	    ,cols: [[
	      ...
	      ,{field:'productSalePrice', title: '产品销售价格'}
	      ,{field:'productSize', title: '产品规格'}
	      ,{field:'salesVolume', title: '产品起售数量'}
	  ...
	  table.on('tool(tableFilter)', function(obj){
	    ...
	    if(layEvent === 'detail'){
	      doDetails('产品详情',data.productId)
	    }
	    if(layEvent === 'del'){
	      doDelete('您确定要删除数据吗？删除后将无法恢复。',data.productId);	
	    }
	    if(layEvent === 'edit'){
	      doForm('修改产品',data.productId);
	    }
	  });
	}); 
	...
	function doForm(title,id){
		layer.open({
			  ...
			  maxmin: true,
			  area: ['100%','100%'],
			  content: '${ctx}/product/toForm?productId='+id,
			  btn: ['立即提交'],
