...
//	      //  headerStyle.setFont(headerFont);
	                      HSSFCellStyle headerStyle = workbook.createCellStyle();        //表格样式
	                      headerStyle.setAlignment(HSSFCellStyle.ALIGN_CENTER);
...
*/
//Web 导出excel
public static void downloadExcelFile(String title,Map<String,String> headMap,JSONArray ja,HttpServletResponse response, int i, OutputStream outXlsx){
    try {
